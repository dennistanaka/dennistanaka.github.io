...
Ubuntu provides their cloud images at [https://cloud-images.ubuntu.com/](https://cloud-images.ubuntu.com/). In my case, I chose to use Bionic 18.04 LTS. I've created a `~/cloud_images` folder to store such files:
